...
exports.createEmployee = async (req, res) => {
    ...
    const save_Employee = new Employee({Name:Name,Gender:Gender,Mobile:Mobile,Email:Email,DOB:DOB,Address:Address,Pincode:Pincode,PincodesService:PincodesService,Latitude:Latitude,Longitude:Longitude,City:City,Services:Services,ServiceKM:ServiceKM});
